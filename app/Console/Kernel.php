            ...
            if ( $api->online )
            {
                ...
                foreach ( $users as $user )
                {
                    ...
                    foreach ( $roles as $role )
                    {
                        ...
                        $var_data = ( settings( 'server_version' ) != '07' ) ? ( $role_data['status']['var_data'] === '' ) ? ['pk_count' => 0, 'dead_flag' => 0] : $api->parseOctet( $role_data['status']['var_data'], 'var_data' ) : ['pk_count' => 0, 'dead_flag' => 0];
