...
class InstallController extends Controller
{
    ...
    {
        pagetitle( [ trans( 'install.welcome.title' ), settings( 'server_name' ) ] );
    ...
    {
        pagetitle( [ trans( 'install.settings.title' ), settings( 'server_name' ) ] );
    ...
    public function complete()
    {
        ...
        pagetitle( [ trans( 'install.complete.title' ), settings( 'server_name' ) ] );
