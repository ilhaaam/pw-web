    ...
    public function boot()
    {
        ...
        view()->composer( 'admin.news.form', function ( $view ) {
            $categories = [
                ...
                'guide' => trans( 'news.category.guide' )
            ];
        ...
        view()->composer( ['admin.shop.form', 'admin.management.mailer'], function ( $view ) {
            $masks = [
                ...
                131072 => trans( 'shop.masks.131072' ),
                262144 => trans( 'shop.masks.262144' ),
                524288 => trans( 'shop.masks.524288' ),
                8388608 => trans( 'shop.masks.8388608' ),
                -2147483585 => trans( 'shop.masks.-2147483585' ),
                -2147483584 => trans( 'shop.masks.-2147483584' ),
                1077936128 => trans( 'shop.masks.1077936128' )
            ];
