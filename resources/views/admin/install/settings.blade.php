...
@section( 'content' )
    <div class="col-md-4 col-md-offset-4">
        ...
        <form method="post" action="{{ route( 'admin.installer.settings.save' ) }}" class="form-horizontal">
            ...
            <div class="form-group form-md-line-input">
                <label class="col-md-4 control-label" for="server_desc">{{ trans( 'system.server_desc' ) }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group form-md-line-input">
                <label class="col-md-4 control-label" for="registration_coin">{{ trans( 'system.registration_coin' ) }}</label>
                <div class="col-md-8">
                    <input name="registration_coin" type="number" class="form-control" id="registration_coin" placeholder="{{ trans( 'system.registration_coin' ) }}" value="{{ settings( 'registration_coin' ) }}">
                    <div class="form-control-focus"> </div>
                </div>
            </div>
            <div class="form-group form-md-line-input">
