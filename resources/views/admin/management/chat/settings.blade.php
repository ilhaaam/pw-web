        ...
        <div class="portlet-body form">
            <form action="{{ url( 'admin/management/chat/settings' ) }}" method="post" class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="num_rows">{{ trans( 'management.fields.chat.num' ) }}</label>
                        <div class="col-md-9">
                            <input name="num_rows" type="text" class="form-control" id="num_rows" value="{{ settings( 'chat_num_rows' ) }}">
                            <div class="form-control-focus"> </div>
                            <span class="help-block">{!! trans( 'management.fields.chat.num_desc' ) !!}</span>
                        </div>
                    </div>
                </div>
