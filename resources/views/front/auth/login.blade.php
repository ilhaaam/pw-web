    ...
    <div class="content">
        ...
        <form class="login-form" action="{{ url( 'auth/login' ) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid placeholder-no-fix" type="password" placeholder="{{ trans( 'main.signin.password' ) }}" name="password" required /> </div>
        ...
        <form class="register-form" action="{{ url( 'auth/register' ) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="{{ trans( 'main.signup.username' ) }}" name="username" required /> 
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control placeholder-no-fix" type="text" placeholder="{{ trans( 'main.signup.email' ) }}" name="email" required />
            </div>
            <div class="form-group">
            ...
            <label class="control-label visible-ie8 visible-ie9">{{ trans( 'main.signup.truename' ) }}</label>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="{{ trans( 'main.signup.truename' ) }}" name="truename" required /> 
            </div>
